...
cA1=appcoef2(c,l,'bior3.7',1); %小波变换近似系数
%D = detcoef2(O,C,S,N) O = 'h'(or 'v',or 'd')
cH1=detcoef2('h',c,l,1);  %the horizontal detail coefficients 
cD1=detcoef2('d',c,l,1);  %the  diagonal detail coefficients
cV1=detcoef2('v',c,l,1);  %the vertical detail coefficients
% 重构第一层系数
